	...
	<div class="form_content">
		...
		<div class="table_info forma_group">
			<div class="table_info_btns">
				<button class="add" onclick="return tableRow_Add(this)">Добавить Строку</button>
				<button class="add" onclick="return tableCol_Add(this)">Добавить Столбец</button>
			</div>
			<table class="forma_group_item">
				<tr class="table_info_head">
					<th></th>
					<?php for($len = 1; $len <= count($DATA[1]); $len++): ?>
						<th><button class="remove" onclick="return tableCol_Delete(this)">X</button></th>
					<?php endfor; ?>
				</tr>
				<?php foreach($DATA as $key => $val): ?>
				<tr>
					<td><button class="remove" onclick="return tableRow_Delete(this)">X</button></td>
		...
		<div class="forma_group">
			...
			<div class="forma_group_item add_table">
				...
				<div class="add_table_btn">
					<button class="add" onclick="return addTable(this)">Добавить</button>
				</div>
			</div>
		</div>
		<?php endif; ?>
